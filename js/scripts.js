(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.video-bg').videoBG({
            mp4: 'http://merzent.com/ali/vids/mp4-cv.mp4',
            ogv: 'http://merzent.com/ali/vids/ogv-cv.ogv',
            webm: 'http://merzent.com/ali/vids/webm-cv.webm',
            poster: 'http://merzent.com/ali/vids/banner-bg.jpg',
            scale: true,
            height: 600,
            position: "relative",
            zIndex: 0
